...
buttonElement.addEventListener("click", moreContent);
...
buttonElement.appendChild(pELem);
}
...
var buttonElement = document.getElementById('less');
buttonElement.addEventListener("click", lessContent);
